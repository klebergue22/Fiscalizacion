...
public class ReporteAccionPerControlador extends FacesUtil implements Serializable{
    ...
    public void generateReport() {
        ...
        try {
            ...
            JasperReportUtil.ReportOutput reportOutput = JasperReportUtil.getOutputStreamsFromReport(conexion, map,JasperReportUtil.PATH_REPORTE_ACCIONES_LIBRO);
    ...
    public void generateReverso() {     
        try {
            ...
            JasperReportUtil jasper = new JasperReportUtil();
            JRExporter exporter = null;
            JasperReportUtil.ReportOutput reportOutput = JasperReportUtil.getOutputStreamsFromReport(conexion, map,JasperReportUtil.PATH_REPORTE_ACCIONES_REVERSO);
                outputStream = reportOutput.getPdfOutputStream();
                excelOutputStream = reportOutput.getExcelOutputStream();
            media = JasperReportUtil.getStreamContentFromOutputStream(outputStream, "application/pdf", getNameFilePdf());
            conexion.close();
