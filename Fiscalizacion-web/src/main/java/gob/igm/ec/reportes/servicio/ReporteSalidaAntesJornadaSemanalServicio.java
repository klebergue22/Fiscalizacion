...
@Stateless
public class ReporteSalidaAntesJornadaSemanalServicio {
    ...
    public ByteArrayOutputStream generar(Date fechaDesde, Date fechaHasta, Short noGestion, String codigo) throws Exception {
