...
@Stateless
public class ReporteOchoHorasSemanalServicio {
    ...
    public ByteArrayOutputStream generarExcel(Date fechaDesde, Date fechaHasta) throws Exception {
        ...
        try (Connection conexion = DriverManager.getConnection(URL, USER, PASSWORD)) {
            return JasperReportUtil.getExcelOutputStreamFromReport(conexion, parametros, JasperReportUtil.PATH_REPORTE_OCHO_HORAS_SEMANAL);
        }
    }
}