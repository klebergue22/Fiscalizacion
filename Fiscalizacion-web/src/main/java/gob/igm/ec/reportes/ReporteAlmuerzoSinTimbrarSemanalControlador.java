...
import gob.igm.ec.reportes.servicio.ReporteAlmuerzoSinTimbrarSemanalServicio;
...
@Named
@SessionScoped
public class ReporteAlmuerzoSinTimbrarSemanalControlador extends FacesUtil implements Serializable {
    ...
    @EJB
    private ReporteAlmuerzoSinTimbrarSemanalServicio reporteAlmuerzoSinTimbrarSemanalServicio;

    public ReporteAlmuerzoSinTimbrarSemanalControlador() {
        this.renderBarra = false;
        this.path = JasperReportUtil.PATH_REPORTE_ALMUERZO_SIN_TIMBRAR_SEMANAL;
    }

    public void generarReporteAlmuerzoSinTimbrarSemanal() {
        try {
