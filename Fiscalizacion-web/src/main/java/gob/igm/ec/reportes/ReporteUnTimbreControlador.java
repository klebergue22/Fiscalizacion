...
@Named
//@ViewScoped
public class ReporteUnTimbreControlador extends FacesUtil implements Serializable {
    ...
    public void generarReporteUnTimbre() {
        try {
            ...
            JasperReportUtil.ReportOutput reportOutput = JasperReportUtil.getOutputStreamsFromReport(conexion, map,JasperReportUtil.PATH_REPORTE_PERMISOS_CODIGO);
